        ...
        <>
            <div role='status' className='animate-pulse space-y-4 max-w-3xl'>
                ...
                <div className="bg-gray-100 rounded dark:bg-gray-700 p-4 space-y-2">
                    <div className="h-2.5 bg-gray-300 rounded dark:bg-gray-700 w-3/4"></div>
                    <div className="h-2.5 bg-gray-300 rounded dark:bg-gray-700 w-2/3"></div>
                    <div className="h-2.5 bg-gray-300 rounded dark:bg-gray-700 w-1/2"></div>
                </div>
            </div>
